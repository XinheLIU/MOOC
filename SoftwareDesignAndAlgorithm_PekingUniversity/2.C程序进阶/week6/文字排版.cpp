/*
 ...
 children they could "buy" acone from me for a hug. Almost immediately,
 ...
 fourchildren they could "buy" a cone from me for a hug. Almost
 immediately, the kidslined up to make their purchases. The three youngest
 each gave me a quick hug,grabbed their cones and raced back outside. But
 when my teenage son at the endof the line finally got his turn to "buy"
...
int main(){
    ...
    for(int i = 0; i < num; i++){
        len = len + strlen(word[i]);          //lengh 用来累计单词量到80
        cout << word[i];
